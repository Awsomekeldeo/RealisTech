...
public class Registration {
	...
	//Item Blocks
		...
		public static final RegistryObject<Item> CRUCIBLE_ITEM = ITEMS.register("crucible", () -> new BlockItem(CRUCIBLE.get(), new Item.Properties().group(ModSetup.TECHMOD_MACHINES)));
