...
public class OreDepositRegistration {
	...
	public void init() {
		...
		this.OreDepositRegistry.register(nickelDepositBlocks, nickelDepositSamples, 6, 40, 30, 17, new String[] { "minecraft:the_end" }, new ArrayList<String>(Arrays.asList(new String[] {"minecraft:stone"})), new ArrayList<Biome>(Arrays.asList(new Biome[] {})), Arrays.asList(new BiomeDictionary.Type[] {}), false, false, PlutonType.DENSE, 1.0f);
		this.OreDepositRegistry.register(leadDepositBlocks, leadDepositSamples, 16, 50, 40, 19, new String[] { "minecraft:the_end" }, new ArrayList<String>(Arrays.asList(new String[] {"minecraft:stone"})), new ArrayList<Biome>(Arrays.asList(new Biome[] {})), Arrays.asList(new BiomeDictionary.Type[] {}), false, false, PlutonType.DENSE, 1.0f);
		this.OreDepositRegistry.register(silverDepositBlocks, silverDepositSamples, 16, 50, 30, 19, new String[] { "minecraft:the_end" }, new ArrayList<String>(Arrays.asList(new String[] {"minecraft:stone"})), new ArrayList<Biome>(Arrays.asList(new Biome[] {})), Arrays.asList(new BiomeDictionary.Type[] {}), false, false, PlutonType.DENSE, 1.0f);
		this.OreDepositRegistry.register(zincDepositBlocks, zincDepositSamples, 35, 55, 20, 19, new String[] { "minecraft:the_end" }, new ArrayList<String>(Arrays.asList(new String[] {"minecraft:stone"})), new ArrayList<Biome>(Arrays.asList(new Biome[] {})), Arrays.asList(new BiomeDictionary.Type[] {}), false, false, PlutonType.DENSE, 1.0f);
		this.OreDepositRegistry.register(cobaltDepositBlocks, cobaltDepositSamples, 16, 32, 50, 15, new String[] { "minecraft:the_end" }, new ArrayList<String>(Arrays.asList(new String[] {"minecraft:stone"})), new ArrayList<Biome>(Arrays.asList(new Biome[] {})), Arrays.asList(new BiomeDictionary.Type[] {}), false, false, PlutonType.DENSE, 1.0f);
		this.OreDepositRegistry.register(coalDepositBlocks, coalDepositSamples, 28, 78, 40, 23, new String[] { "minecraft:the_end" }, new ArrayList<String>(Arrays.asList(new String[] {"minecraft:stone"})), new ArrayList<Biome>(Arrays.asList(new Biome[] {})), Arrays.asList(new BiomeDictionary.Type[] {}), false, false, PlutonType.DENSE, 1.0f);
		this.OreDepositRegistry.register(ironDepositBlocks, ironDepositSamples, 32, 60, 50, 22, new String[] { "minecraft:the_end" }, new ArrayList<String>(Arrays.asList(new String[] {"minecraft:stone"})), new ArrayList<Biome>(Arrays.asList(new Biome[] {})), Arrays.asList(new BiomeDictionary.Type[] {}), false, false, PlutonType.DENSE, 1.0f);
		this.OreDepositRegistry.register(goldDepositBlocks, goldDepositSamples, 5, 40, 35, 19, new String[] { "minecraft:the_end" }, new ArrayList<String>(Arrays.asList(new String[] {"minecraft:stone"})), new ArrayList<Biome>(Arrays.asList(new Biome[] {})), Arrays.asList(new BiomeDictionary.Type[] {}), false, false, PlutonType.DENSE, 1.0f);
		this.OreDepositRegistry.register(diamondDepositBlocks, diamondDepositSamples, 2, 20, 20, 15, new String[] { "minecraft:the_end" }, new ArrayList<String>(Arrays.asList(new String[] {"minecraft:stone"})), new ArrayList<Biome>(Arrays.asList(new Biome[] {})), Arrays.asList(new BiomeDictionary.Type[] {}), false, false, PlutonType.DENSE, 1.0f);
