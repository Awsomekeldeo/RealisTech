	...
	public static List<Item> getItemList(ItemGroup group) {
		...
		if (group == REALISTECH_TOOLS) {
			return Arrays.asList(new Item[] {
				...
				Registration.COPPER_AXE_HEAD.get(),
				Registration.COPPER_SHOVEL_HEAD.get(),
				Registration.COPPER_PICKAXE_HEAD.get(),
				Registration.COPPER_PROPICK_HEAD.get(),
				Registration.COPPER_SWORD_HEAD.get(),
				Registration.BRONZE_AXE_HEAD.get(),
				Registration.BRONZE_SHOVEL_HEAD.get(),
				Registration.BRONZE_PICKAXE_HEAD.get(),
				Registration.BRONZE_PROPICK_HEAD.get(),
				Registration.BRONZE_SWORD_HEAD.get(),
				...
				Registration.COPPER_AXE.get(),
				Registration.COPPER_SHOVEL.get(),
				Registration.COPPER_PICKAXE.get(),
				Registration.COPPER_PROPICK.get(),
				Registration.COPPER_SWORD.get(),
				Registration.BRONZE_AXE.get(),
				Registration.BRONZE_SHOVEL.get(),
				Registration.BRONZE_PICKAXE.get(),
				Registration.BRONZE_PROPICK.get(),
				Registration.BRONZE_SWORD.get()
			});
		}
